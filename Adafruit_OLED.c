...
*/
    ...
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0); //setting DC low - pin 15
    GPIOPinWrite(GPIOA1_BASE, 0x10, 0); //setting CS low - pin 3
    MAP_SPIDataPut(GSPI_BASE, c); //writing data
    MAP_SPIDataGet(GSPI_BASE, &data);
    GPIOPinWrite(GPIOA1_BASE, 0x10, 0x10); //setting CS high
...
*/
    unsigned long data;
    MAP_SPICSEnable(GSPI_BASE);
    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x40); //setting DC high - pin 15
    GPIOPinWrite(GPIOA1_BASE, 0x10, 0); //setting CS low - pin 3
    MAP_SPIDataPut(GSPI_BASE, c); //writing data --- not sure if this is correct
    MAP_SPIDataGet(GSPI_BASE, &data);
    GPIOPinWrite(GPIOA1_BASE, 0x10, 0x10); //setting CS high
    MAP_SPICSDisable(GSPI_BASE);
}
